...
export const TwoColContactUsWithIllustrationFullForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // let response = 
    await fetch("http://0.0.0.0:5000/contact", {
      method: "POST",
      headers: {
  ...
  const heading = <><span tw="text-primary-500">Get in touch</span><wbr /> with me.</>
  const description = "I want to hear from you! Send me a message and I'll be sure to get back to you as soon as possible."
  const formAction = "#"
